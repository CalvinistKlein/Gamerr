...
class AutomationService:
    ...
    def _run_loop(self):
        ...
        # Use the app passed to start(), or fall back to creating one
        # (create_app() fallback only used when called from scripts, not inside Flask)
    ...
    def _select_best_result(self, results: List[Dict], wanted_game: WantedGame) -> Optional[Dict]:
        ...
        for result in results:
            ...
            wanted_platform = wanted_game.platform.lower()
            ...
            if wanted_game.region_preference:
                ...
                wanted_region = wanted_game.region_preference.lower()
